...
#CENPA + CENPC
traj = '/Users/mpitman/work/dt/nuc/cenpc/contr/trajectories/md6/traj_md1_coarse.xtc'
struc = '/Users/mpitman/work/dt/nuc/cenpc/contr/structure_files/cenpc_contr_t0.gro'
...
#CENPA + CENPC
cap = u.select_atoms('protein and name CA') + u.select_atoms('bynum 728:4733 and name P')  + u.select_atoms('bynum 5340:9343 and name P')
...
#describe distributions generated
import pandas as pd
